...
typedef cbor_item_t *(*tenkei_user_data)(cbor_item_t *);

void tenkei_callback(void *f, uint8_t *arg, size_t arg_len, uint8_t **res, size_t *res_len)
{
  tenkei_user_data f_ = (tenkei_user_data)f;
  offer_cbor(f_, arg, arg_len, res, res_len);
}
