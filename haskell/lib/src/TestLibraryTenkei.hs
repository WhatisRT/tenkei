...
tenkei_apply_function = offerCBOR (\(CBOR_Array [arg1, arg2]) -> serialize $ tenkei_apply_function_helper (TenkeiValue . (fromFunPointer (deserialize arg1)) . (\x0 -> CBOR_Array [getValue x0])) (deserialize arg2))
